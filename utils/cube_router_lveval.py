...
from hypercube.lveval.hypercube_cultural_product import retriever_hypercube_cultural_product
from hypercube.lveval.hypercube_person import retriever_hypercube_person
from hypercube.lveval.hypercube_location import retriever_hypercube_location
...
def route_query_to_retrieve_docs_lveval(query, corpus, k):
    router_prompt = """
    ...
    If the query is centered with location (asking specific places, river, hill, company, or geographic information), e.g., where was Marufabad and Nasamkhrali, you need to return 'LOCATION' since the key information is related to the location Marufabad and Nasamkhrali.
