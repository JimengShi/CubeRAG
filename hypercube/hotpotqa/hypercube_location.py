...
from utils.decompose_hotpotqa import decompose_query_along_location
...
dimensions = ['location_name', 'company_organization', 'location_relation']
    ...
    with open(f'hypercube_new/hotpotqa/{dimension}.txt') as f:
        ...
        for i, line in tqdm(enumerate(readin), total=len(readin), desc=f"{dimension}"):
            ...
            for k in tmp:
                ...
                # embed_string(target_str=k, emb_model=model, dict_path='ent2emb/ent2emb_hotpotqa_location.pkl', )
